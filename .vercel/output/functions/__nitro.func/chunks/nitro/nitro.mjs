...
const handlers = [
  ...
  { route: '/**', handler: _lazy_DVBsHN, lazy: true, middleware: false, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/jorge/catalogo_gretel/.data/kv"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "bcc06438-fdd4-485f-90f9-a0f3ed0617bb",
